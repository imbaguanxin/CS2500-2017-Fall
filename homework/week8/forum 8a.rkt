...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |forum 8a|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; draw a single entry to a image
;; string -> image
(define (draw-edit-message m)
  (text m 20 "black"))

;; helper function: overlay!
